...
<html lang="en">
  ...
  case "3":
    ...
    break;
                        ...
                        <option value="level_income.php?pin_type=7" <?php echo $g;?> >Emerald</option>
                        <option value="level_income.php?pin_type=8" <?php echo $h;?>>Ruby</option>
                        <option value="level_income.php?pin_type=9" <?php echo $i;?>>Saphire</option>
                        <option value="level_income.php?pin_type=10" <?php echo $j;?>>Crown</option>
                        <option value="level_income.php?pin_type=11" <?php echo $k;?>>Legend</option>
                    </select>
                          </span>
                        </div>
                      </div>
