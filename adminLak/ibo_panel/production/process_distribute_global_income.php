    ...
    if($dis_fet[a_plan]>='1')
    {
        if($plan_in_fet[plan1]<=6000)
        {
            ...
            if($planspp<=6000)
            {
                ...
                $plan_iv_h="INSERT INTO `plan_income_manage_history` (`pimh_id`, `d_id`, `plan_no`, `date`, `time`, `bal`, `b_bal`, `a_bal`, `type`, `note`, `com_note`, `of_d_id`, `commission`, `level`, `orbit`) VALUES (NULL, '$d_id', '1', '$date', '$time', '$amount', '$plan_in_fet[plan1]', '$planspp', '+', 'Global 1000rs', '', '$d_id', 'y', '$level', '$plan_in_fet[o1]');";
                $ww_ins="INSERT INTO `withdrawal_wallet_history` (`wwh_id`, `d_id`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `type`, `note`, `plan_type`) VALUES (NULL, '$d_id', '$date', '$time', '$amount', '$dis_fet[withdrawal_wallet]', '$ww_bal', '+', 'Global 1', '1');";
            ...
            elseif($planspp>6000)
            {
                ...
                /////////////////
                $upg_ins="INSERT INTO `upgrade_wallet_history` (`uwh_id`, `d_id`, `date`, `time`, `plan_type`, `level`, `amount`, `b_bal`, `a_bal`, `note`, `type`, `orbit`) VALUES (NULL, '$d_id', '$date', '$time', 'Global 1000rs', '$level', '$extra_bal', '$dis_fet[upgrade_wallet]', '$upg_bal', 'For Upgrading', '+', '$plan_in_fet[o1]');";
                ...
                $plan_iv_h="INSERT INTO `plan_income_manage_history` (`pimh_id`, `d_id`, `plan_no`, `date`, `time`, `bal`, `b_bal`, `a_bal`, `type`, `note`, `com_note`, `of_d_id`, `commission`, `level`, `orbit`) VALUES (NULL, '$d_id', '1', '$date', '$time', '$amount', '$plan_in_fet[plan1]', '$planspp', '+', 'Global 1000rs', '', '$d_id', 'y', '$level', '$plan_in_fet[orbit]');";
                /////////////////////////////////////
                $ww_ins="INSERT INTO `withdrawal_wallet_history` (`wwh_id`, `d_id`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `type`, `note`, `plan_type`) VALUES (NULL, '$d_id', '$date', '$time', '$ww_com', '$dis_fet[withdrawal_wallet]', '$ww_bal', '+', 'Global 1', '1');";
                $ww_up="UPDATE `distributor` SET `withdrawal_wallet` = '$ww_bal' WHERE `distributor`.`d_id` = '$d_id';";
        ...
        elseif($plan_in_fet[plan1]>6000 && $plan_in_fet[plan1]<=8000)
        {
            ...
            if($planspp<=8000)
            {
                ...
                $upg_ins="INSERT INTO `upgrade_wallet_history` (`uwh_id`, `d_id`, `date`, `time`, `plan_type`, `level`, `amount`, `b_bal`, `a_bal`, `note`, `type`, `orbit`) VALUES (NULL, '$d_id', '$date', '$time', 'Global 1000rs', '$level', '$amount', '$dis_fet[upgrade_wallet]', '$upg_bal', 'For Upgrading', '+', '$plan_in_fet[o1]');";
                $upg_up="UPDATE `distributor` SET `upgrade_wallet` = '$upg_bal' WHERE `distributor`.`d_id` = '$d_id';";
            ...
            elseif($planspp>8000)
            {
                ...
                $plan_iv_h="INSERT INTO `plan_income_manage_history` (`pimh_id`, `d_id`, `plan_no`, `date`, `time`, `bal`, `b_bal`, `a_bal`, `type`, `note`, `com_note`, `of_d_id`, `commission`, `level`, `orbit`) VALUES (NULL, '$d_id', '1', '$date', '$time', '$amount', '$plan_in_fet[plan1]', '$planspp', '+', 'Global 1000rs', '', '$d_id', 'y', '$level', '$plan_in_fet[orbit]');";
                ///////////////////////////////////////////////////
                $upg_ins="INSERT INTO `upgrade_wallet_history` (`uwh_id`, `d_id`, `date`, `time`, `plan_type`, `level`, `amount`, `b_bal`, `a_bal`, `note`, `type`, `orbit`) VALUES (NULL, '$d_id', '$date', '$time', 'Global 1000rs', '$level', '$upg_com', '$dis_fet[upgrade_wallet]', '$upg_bal', 'For Upgrading', '+', '$plan_in_fet[orbit]');";
                $upg_up="UPDATE `distributor` SET `upgrade_wallet` = '$upg_bal' WHERE `distributor`.`d_id` = '$d_id';";
                ...
                $rf_ins="INSERT INTO `reserve_fund_history` (`rfh_id`, `rf_type`, `d_id`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `type`, `note`) VALUES (NULL, '1', '$d_id', '$date', '$time', '$extra_bal', '$rf_fet[rf1]', '$rf_a_bal', '+', 'Global 1000rs');";
        ...
        elseif($plan_in_fet[plan1]>8000 && $plan_in_fet[plan1]<=9000)
        {
            ...
            if($planspp<=9000)
            {
                ...
                $rf_ins="INSERT INTO `reserve_fund_history` (`rfh_id`, `rf_type`, `d_id`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `type`, `note`, `orbit`) VALUES (NULL, '1', '$d_id', '$date', '$time', '$amount', '$rf_fet[rf1]', '$rf_a_bal', '+', 'Global 1000rs', '$plan_in_fet[o1]');";
                $rf_up="UPDATE `reserve_fund` SET `rf1` = '$rf_a_bal' WHERE `reserve_fund`.`rf_id` = 1;";
            ...
            elseif($planspp>9000)
            {
                ...
                $rf_ins="INSERT INTO `reserve_fund_history` (`rfh_id`, `rf_type`, `d_id`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `type`, `note`, `orbit`) VALUES (NULL, '1', '$d_id', '$date', '$time', '$rf_com', '$rf_fet[rf1]', '$rf_a_bal', '+', 'Global 1000rs', '$plan_in_fet[o1]');";
                $rf_up="UPDATE `reserve_fund` SET `rf1` = '$rf_a_bal' WHERE `reserve_fund`.`rf_id` = 1;";
                
                ////////////////////////for renewal fund
                $renewal_bal=$dis_fet[renewal_wallet]+$extra_bal;
                $renwal_ins="INSERT INTO `renewal_wallet_history` (`rwh_id`, `d_id`, `plan_type`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `note`, `orbit`, `type`) VALUES (NULL, '$d_id', '1', '$date', '$time', '$extra_bal', '$dis_fet[renewal_wallet]', '$renewal_bal', 'Global 1000rs', '$plan_in_fet[o1]', '+');";
        ...
        elseif($plan_in_fet[plan1]>9000 && $plan_in_fet[plan1]<=10000)
        {
            ...
            if($planspp<=10000)
            {
                ...
                $renwal_ins="INSERT INTO `renewal_wallet_history` (`rwh_id`, `d_id`, `plan_type`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `note`, `orbit`, `type`) VALUES (NULL, '$d_id', '1', '$date', '$time', '$amount', '$dis_fet[renewal_wallet]', '$renewal_bal', 'Global 1000rs', '$plan_in_fet[o1]', '+');";
                $renewal_up="UPDATE `distributor` SET `renewal_wallet` = '$renewal_bal' WHERE `distributor`.`d_id` = '$d_id';";
            ...
            elseif($planspp>10000)
            {
                ...
                $plan_iv_h="INSERT INTO `plan_income_manage_history` (`pimh_id`, `d_id`, `plan_no`, `date`, `time`, `bal`, `b_bal`, `a_bal`, `type`, `note`, `com_note`, `of_d_id`, `commission`, `level`, `orbit`) VALUES (NULL, '$d_id', '1', '$date', '$time', '$b_amount', '$plan_in_fet[plan1]', '$b_plan', '+', 'Global 1000rs', '', '$d_id', 'y', '$level', '$plan_in_fet[o1]');";
                
                
                ////////////////////////for renewal fund
                $renewal_bal=$dis_fet[renewal_wallet]+$b_amount;
                $renwal_ins="INSERT INTO `renewal_wallet_history` (`rwh_id`, `d_id`, `plan_type`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `note`, `orbit`, `type`) VALUES (NULL, '$d_id', '1', '$date', '$time', '$b_amount', '$dis_fet[renewal_wallet]', '$renewal_bal', 'Global 1000rs', '$plan_in_fet[o1]', '+');";
                $renewal_up="UPDATE `distributor` SET `renewal_wallet` = '$renewal_bal' WHERE `distributor`.`d_id` = '$d_id';";
                ...
                $plan_iv_h="INSERT INTO `plan_income_manage_history` (`pimh_id`, `d_id`, `plan_no`, `date`, `time`, `bal`, `b_bal`, `a_bal`, `type`, `note`, `com_note`, `of_d_id`, `commission`, `level`, `orbit`) VALUES (NULL, '$d_id', '1', '$date', '$time', '$extra_bal', '0', '$extra_bal', '+', 'Global 1000rs', '', '$d_id', 'y', '$level', '$orbit');";
                $ww_bal=$dis_fet[withdrawal_wallet]+$extra_bal;
                $ww_ins="INSERT INTO `withdrawal_wallet_history` (`wwh_id`, `d_id`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `type`, `note`, `plan_type`) VALUES (NULL, '$d_id', '$date', '$time', '$extra_bal', '$dis_fet[withdrawal_wallet]', '$ww_bal', '+', 'Global 1', '1');";
                $ww_up="UPDATE `distributor` SET `withdrawal_wallet` = '$ww_bal' WHERE `distributor`.`d_id` = '$d_id';";
...
//echo $glo_bal_fet[g1];
if($glo_bal_fet[g1]>0){
    $sel="SELECT * FROM `distributor` WHERE `a_plan`>='1' AND `global_status`='y';";
    $fvb=$con->query($sel);
    $b_count=$fvb->num_rows;
    echo $b_count."Total person<br>";
    $per_member_amount=$glo_bal_fet[g1]/$b_count;
    echo $per_member_amount."per person amount";
    while($fds=$fvb->fetch_assoc())
    {
        for_amount_insert_by_orbit_plan1($fds[d_id],$per_member_amount,'0');
        echo $fds[d_id]."<br>";
      /*  $wallet=$fds[withdrawal_wallet]+$per_member_amount;
        $rfe="INSERT INTO `withdrawal_wallet_history` (`wwh_id`, `d_id`, `date`, `time`, `amount`, `b_bal`, `a_bal`, `type`, `note`, `plan_type`, `from_d_id`, `to_d_id`, `global_type`) VALUES (NULL, '$fds[d_id]', '$date', '$time', '$per_member_amount', '$fds[withdrawal_wallet]', '$wallet', '+', 'Global 1', '', '', '', '1');";
    ...
    $glo_up="UPDATE `global_support_system_bal` SET `g1` = '0' WHERE `global_support_system_bal`.`gssb_id` = 1;";
    $glo_ent="INSERT INTO `global_bal_history` (`gbh_id`, `global_type`, `date`, `time`, `bal`, `b_bal`, `a_bal`, `type`, `d_id`, `note`, `s_note`) VALUES (NULL, '1', '$date', '$time', '$glo_bal_fet[g1]', '$glo_bal_fet[g1]', '0', '-', '', 'Daily Distributed', '');";
    $gbl="INSERT INTO `global_income_distributed` (`gid_id`, `g_type`, `d_id`, `date`, `time`, `amount`, `note`, `no_person`, `per_member_amount`) VALUES (NULL, '1', '', '$date', '$time', '$glo_bal_fet[g1]', '', '$b_count', '$per_member_amount');";
    ...
    $selw="SELECT * FROM `distributor` WHERE `a_plan`='1' AND `global_status`='N';";
    $fvbw=$con->query($selw);
