<footer class="w3l-footer-22 py-5">
        <div class="container py-md-5 py-4">
            <div class="row sub-columns">
                <div class="col-lg-4 col-sm-6 sub-one-left">
                    <h6>About </h6>
                    <p>Futurecare is an open fundraising platform for all fundraiser, Raise fund for any cause Worldwide.</p>
                    <div class="columns-2">
                        <ul class="social">
                ...
                <div class="col-lg-2 col-sm-6 sub-two-right mt-lg-0 mt-sm-5 mt-4">
                    ...
                    <ul>
                        ...
                        <li><a href="about.php"><span class="fas fa-angle-right mr-2"></span>About</a>
                        </li>
                        <!--<li><a href="#blog"><span class="fas fa-angle-right mr-2"></span>Blog Posts</a>-->
                        <!--</li>-->
                        <li><a href="contact.php"><span class="fas fa-angle-right mr-2"></span>Contact</a></li>
                    </ul>
                </div>
            ...
            <div class="sub-contact mt-5 pt-lg-4">
                <div class="row">
                    ...
                    <div class="col-md-4 footer-contact d-flex align-items-center active">
                        ...
                        <div>
                            <a href="tel:+44-000-888-999">+91-XX-XXXX-XXXX</a>
                            <p>Call Us Now</p>
                        </div>
                    </div>
                    <!--<div class="col-md-4 footer-contact d-flex align-items-center">-->
                    ...
                    <!--    <div>-->
                    <!--        <h5> Gwalior,Madhya Pradesh ,India</h5>-->
                    <!--        <p>Get Direction</p>-->
                    <!--    </div>-->
                    <!--</div>-->
                </div>
        ...
        <div class="copyright-footer text-center">
            <div class="container">
                <div class="columns">
                    <p>@2021 Future Care. All rights reserved. 
                    </p>
                </div>
            </div>
        </div>
